...
import { EntityArrayResponseType, MerchantService } from '../service/merchant.service';
...
export class MerchantComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.merchants.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IMerchant[] | null): IMerchant[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.merchantService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
