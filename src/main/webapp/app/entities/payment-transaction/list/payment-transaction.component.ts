...
export class PaymentTransactionComponent implements OnInit {
  ...
  protected readonly paymentTransactionService = inject(PaymentTransactionService);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.paymentTransactions.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IPaymentTransaction[] | null): IPaymentTransaction[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.paymentTransactionService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
