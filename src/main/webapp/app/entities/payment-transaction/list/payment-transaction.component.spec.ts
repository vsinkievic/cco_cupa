...
import { sampleWithRequiredData } from '../payment-transaction.test-samples';
...
describe('PaymentTransaction Management Component', () => {
  let comp: PaymentTransactionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PaymentTransactionComponent, '')
      .compileComponents();
